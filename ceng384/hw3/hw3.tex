...
\item \begin{enumerate}
    \item \begin{figure}[H]
        \caption{Function for Spectral Coefficients}
        \inputminted{python}{q8a.py}
        \end{figure}
    \item \begin{figure}[H]
        \caption{Class for Approximating from Spectral Coefficients}
        \inputminted{python}{q8b.py}
    \end{figure}
    \item \begin{figure}[H]
        \caption{Code for Reconstructing the Square Wave}
        \inputminted{python}{q8c.py}
    \end{figure}
    \item \begin{figure}[H]
        \caption{Code for Reconstructing the Sawtooth Wave}
        \inputminted{python}{q8d.py}
    \end{figure}
\end{enumerate}
\end{enumerate}
