...
\item %write the solution of q4
    ...
    % sketch magnitude and phase of bk, i.e., sketch |bk| and\anglebk.
    ...
    \begin{figure}
        ...
        \begin{tikzpicture}
            ...
            axis x line=center, 
            axis y line = center, 
            xmin=-2.5, xmax=2.5, ymin=-0.1, ymax=0.5]
            \addplot+[ycomb,mark=square] plot coordinates {(-2,0.03966) (-1,0.1757) (0,1) (1,0.1757) (2,0.03966)};
            \end{axis}
        \end{tikzpicture}
        \caption{Graph of $|b_k|$}
    \end{figure}
    ...
    \begin{figure}
        ...
        \begin{tikzpicture}
            ...
            axis y line = center, 
            xmin=-2.5, xmax=2.5, ymin=-2.5, ymax=2.5]
            \addplot+[ycomb,mark=square] plot coordinates {(-2,0.8468) (-1,-0.306) (0,1) (1,0.306) (2,-0.8468)};
            \end{axis}
        \end{tikzpicture}
        \caption{Graph of $\angle b_k$}
    \end{figure}
...
\end{figure}
    ...
    \begin{enumerate}
        ...
        \begin{align*}
            y[n] & = x[n] - \Sigma_{k=-\infty}^{\infty} \delta [n - (3 + 4k)] \\
        \end{align*}
