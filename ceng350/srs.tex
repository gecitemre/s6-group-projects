...
\begin{document}
        ...
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam eget libero sollicitudin justo vehicula venenatis quis ut eros. Proin vitae.
            ...
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam eget libero sollicitudin justo vehicula venenatis quis ut eros. Proin vitae.
                ...
                \begin{center}
                    \par
                    \begin{tabular}{cc}
                        \fbox{\includegraphics[width=1\linewidth]{./assets/context_diagram.pdf}}
                    \end{tabular}
                    \par
    ...
    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam eget libero sollicitudin justo vehicula venenatis quis ut eros. Proin vitae.
        ...
        \begin{center}
            ...
            \end{table}
            \captionof{table}{See PDF About Hatay Function}
            \vspace{1cm}
            ...
            \begin{table}[h]
                ...
                \textbf{Alternative flow} & -                                                                                                                                                                                                            \\ \hline
                \textbf{Exception flow}   & -                                                                                                                                                                                                              \\ \hline
                \textbf{Post conditions}  & The user is redirected to depremyardim.com.
                \end{tabular}%
                }
            \end{table}
            ...
            \begin{table}[h]
                ...
                \textbf{Description}      & \begin{tabular}[c]{@{}l@{}}Afetharita.com is a website that provides map based information about the earthquake. \\
                                            The map includes information about the earthquake, the aftershocks, the shelters, the hospitals, the schools and more. \end{tabular} \\ \hline
                \textbf{Data}            & \begin{tabular}[c]{@{}l@{}}URL of the website.                   \end{tabular} \\ \hline
                \textbf{Preconditions}   & -                                                                                                                                                                     \\ \hline
                \textbf{Stimulus}        & User clicks the related button.                                                                                                                                               \\ \hline
                \textbf{Basic flow}     & \begin{tabular}[c]{@{}l@{}}Step 1: The user hovers over the button. 
                ...
                \textbf{Alternative flow} & -                                                                                                                                                                                                            \\ \hline
                \textbf{Exception flow}   & -                                                                                                                                                                                                              \\ \hline
                \textbf{Post conditions}  & The user is redirected to afetharita.com.
                \end{tabular}%
                }
            ...
            \begin{table}[h]
                ...
                \textbf{Alternative flow} & -                                                                                                                                                                                                            \\ \hline
                \textbf{Exception flow}   & -                                                                                                                                                                                                              \\ \hline
                \textbf{Post conditions}  & The user is redirected to deprem.io.
                \end{tabular}%
                }
            \end{table}
            ...
            \begin{table}[h]
                ...
                \textbf{Actors}           & User, Static Website                                                                                                                                                                                           \\ \hline
                \textbf{Description}      & \begin{tabular}[c]{@{}l@{}} The Discord server is where the developers of this project develop their projects and communicate. \\ \hline
            ...
            \begin{table}[h]
                ...
                \textbf{Actors}           & User, Static Website                                                                                                                                                                                           \\ \hline
                \textbf{Description}      & \begin{tabular}[c]{@{}l@{}} Users may need information about only one city. \\ \hline
