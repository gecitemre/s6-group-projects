...
\begin{document}
    ...
    \section{Introduction}
        ...
        \subsection{Purpose of the System}
            ...
            \subsection{System Overview}
                ...
                \begin{itemize}
                    \item \textbf{See PDF About a City}: If a user wants to see the PDF document containing information about a city, the city selection dialog is shown, then the desired is picked on the dialog.
                    \item \textbf{Kızılay Donation Centers}: If a user wants to see the donation centers of Kızılay, the donation centers are shown on the map.
                    \item \textbf{Generate PDF Documents}: Automatic PDF generation. The PDF files include information about affected areas.
                    \item \textbf{Show Maps}: Shows a map of useful locations in the affected area.
                    \item \textbf{TODO}: continue here
                \end{itemize}
    ...
    \section{Suggestions for Future Work}
        ...
        \textbf{Draft Ideas}
        \begin{itemize}
            \item This system can be improved and held ready for future earthquakes and any possible disasters.
        \end{itemize}
