...
\begin{document}
    ...
    \section{Specific Requirements}
        ...
        \begin{center}
            ...
            \begin{table}[H]
                ...
                \captionof{table}[H]{Generating PDF Documents Function}
            \end{table}
            
            \begin{figure}[H]
                \centering
                \includesvg[inkscapelatex=false, width=0.4\textwidth]{assets/ActivityDiagram-registered.svg}
            ...
            \begin{table}[H]
                ...
                \captionof{table}[H]{Showing Maps Function}
            \end{table}
            \vspace{1cm}
            ...
            \begin{table}[H]
                ...
                \captionof{table}[H]{Changing Language Function} 
            \end{table}
            \vspace{1cm}
            ...
            \begin{table}[H]
                ...
                \captionof{table}[H]{Reaching to depremyardim.com Function}
            \end{table}
            \vspace{1cm}
            ...
            \begin{table}[H]
                ...
                \captionof{table}[H]{Reaching to afetharita.com Function}
            \end{table}
            \begin{figure}[H]
                \centering
                \includesvg[width=\textwidth, inkscapelatex=false]{assets/StateDiagram-registered.svg}
            ...
            \begin{table}[H]
                ...
                \captionof{table}[H]{Reaching to deprem.io Function}
            \end{table}
            \vspace{1cm}
            ...
            \begin{table}[H]
                ...
                \captionof{table}[H]{Join the Discord server Function}
            \end{table}
            \vspace{1cm}
            ...
            \begin{table}[H]
                ...
                \captionof{table}[H]{City Selection Function}
            \end{table}
            \vspace{1cm}
        \begin{figure}[H]
            \centering
            \includesvg[width=\textwidth, inkscapelatex=false]{assets/SequenceDiagram-registered.svg}
    ...
    the system can be made more reliable and quick.
        ...
        \begin{table}[H]
            ...
            \begin{tabular}{|l|l|}
            \hline
            \textbf{Suggested Function}    & \textbf{Summary}\\ \hline
            \textbf{Get data from verified information source}           & \begin{tabular}[c]{@{}l@{}}System fetches data from the verified\\information sources automatically.\end{tabular} \\ \hline
            \textbf{Submit Information} & \begin{tabular}[c]{@{}l@{}}System allows users to submit information\\about the disaster situation.\end{tabular} \\ \hline
            \textbf{Filter Information for Disaster} & \begin{tabular}[c]{@{}l@{}}System filters the information according to\\a specific disaster.\end{tabular} \\ \hline
            \textbf{Information About What to Do} & \begin{tabular}[c]{@{}l@{}}System provides information about what to do\\in a disaster situation for future disasters.\end{tabular} \\ \hline
            \end{tabular}%
            }
            \captionof{table}{System Function Suggestions}
        \end{table}
        \vspace{1cm}
