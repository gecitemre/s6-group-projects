...
\begin{document}
    ...
    the system can be made more reliable and quick.
        ...
        \begin{table}[H]
            ...
            \captionof{table}[H]{Get Data from Verified Information Source Function}
        \end{table}
        \vspace{1cm}
        ...
        \begin{table}[H]
            ...
            \captionof{table}[H]{Submit Information Function}
        \end{table}
        \vspace{1cm}
        ...
        \begin{table}[H]
            ...
            \captionof{table}[H]{Filter Information Function}
        \end{table}
        \vspace{1cm}
        ...
        \begin{table}[H]
            ...
            \captionof{table}[H]{Information About What to Do Function}
        \end{table}
        \vspace{1cm}
        ...
        \begin{table}[H]
            ...
            \captionof{table}[H]{Heat Map Function}
        \end{table}
        \vspace{1cm}
