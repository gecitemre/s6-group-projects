        ...
        \subsection{Purpose of the System}
            ...
            \subsection{System Overview}
                ...
                \begin{table}[h]
                    ...
                    \textbf{See PDF About a City}           & \begin{tabular}[c]{@{}l@{}}If a user wants to see the PDF document containing\\ information about a city, the city selection dialog \\ is shown, then the desired is picked on \\ the dialog.\end{tabular}                                                                                                                                                                                           \\ \hline
                    \textbf{Kızılay Donation Centers}      & \begin{tabular}[c]{@{}l@{}}If a user wants to see the donation centers of Kızılay,\\ the donation centers are shown on the map.\end{tabular} \\ \hline
